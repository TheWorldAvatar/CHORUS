...
readme.txt states the organising principle: the datasets follow a tracking spreadsheet, exploration is tracked via GitHub issues, and "folders have the issue number as the last 2 digits of the name". The contact given is gary.lloyd@manchester.ac.uk.
